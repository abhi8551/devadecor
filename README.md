...
| Page | File | Purpose |
|------|------|---------|
| Homepage | `index.html` | Hero slideshow, featured products, deals, testimonials, newsletter |
| Shop All | `shop.html` | Full catalog with filters, sort, grid/list toggle |
| Category Pages | `shop.html?cat=X` | Deep-linked category views (wall-art, lighting, furniture, vases, rugs, mirrors, textiles) |
| Product Detail | `product.html?id=X` | Dynamic product page with gallery, comparison table, sticky CTA |
| Living Room | `room-living.html` | "Shop the Look" — living room inspiration with tagged products |
| Bedroom | `room-bedroom.html` | "Shop the Look" — bedroom inspiration with tagged products |
| Dining Room | `room-dining.html` | "Shop the Look" — dining room inspiration with tagged products |
| Journal | `journal.html` | Article index with 6 linked articles |
| Mindful Spaces | `journal-post.html` | Article: The Art of Mindful Living Spaces |
| Bookshelf Guide | `journal-bookshelf.html` | Article: 5 Ways to Style Your Bookshelf |
| Spring Trends | `journal-spring-trends.html` | Article: Spring Decor Trends 2026 |
| Rug Guide | `journal-rug-guide.html` | Article: Complete Guide to Choosing a Rug |
| Lighting Guide | `journal-lighting-guide.html` | Article: Room-by-Room Lighting Guide |
| Small Spaces | `journal-small-spaces.html` | Article: Maximizing Small Spaces |
| Contact | `contact.html` | Contact form, FAQ accordion, showroom info |
...
- **Category landing pages** via `shop.html?cat=wall-art` with dynamic titles and meta
...
devadecorwebsite/
├── index.html              # Homepage
├── shop.html               # Shop + category pages
├── product.html            # Product detail (dynamic via ?id=)
├── room-living.html        # Living room inspiration
├── room-bedroom.html       # Bedroom inspiration
├── room-dining.html        # Dining room inspiration
├── journal.html            # Journal index
├── journal-post.html       # Article: Mindful Living Spaces
├── journal-bookshelf.html  # Article: Bookshelf Styling
├── journal-spring-trends.html  # Article: Spring Trends
├── journal-rug-guide.html  # Article: Rug Guide
├── journal-lighting-guide.html # Article: Lighting Guide
├── journal-small-spaces.html   # Article: Small Spaces
...
1. **Replace Formspree IDs** — Search for `YOUR_FORM_ID` in `js/app.js` and `contact.html`. Replace with your Formspree form endpoint (create one free at [formspree.io](https://formspree.io)).
